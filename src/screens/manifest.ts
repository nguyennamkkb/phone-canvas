...
{ id: 'home', title: 'Home · Today', file: 'project/moodtracker/home.html' },
  { id: 'c01-splash', title: 'S01 · Splash / Launch', file: 'project/caloai/c01-splash.html' },
  { id: 'c02-welcome', title: 'S02 · Welcome / Value Proposition', file: 'project/caloai/c02-welcome.html' },
  { id: 'c03-goal', title: 'S03 · Primary Goal', file: 'project/caloai/c03-goal.html' },
  { id: 'c04-motivation', title: 'S04 · Motivation', file: 'project/caloai/c04-motivation.html' },
  { id: 'c05-profile', title: 'S05 · Body Profile', file: 'project/caloai/c05-profile.html' },
  { id: 'c06-target-weight', title: 'S06 · Target Weight & Pace', file: 'project/caloai/c06-target-weight.html' },
  { id: 'c07-activity', title: 'S07 · Activity & Lifestyle', file: 'project/caloai/c07-activity.html' },
  { id: 'c08-diet', title: 'S08 · Diet Preferences', file: 'project/caloai/c08-diet.html' },
  { id: 'c09-your-target', title: 'S09 · Personalized Target', file: 'project/caloai/c09-your-target.html' },
  { id: 'c10-forecast', title: 'S10 · Plan Forecast', file: 'project/caloai/c10-forecast.html' },
  { id: 'c11-paywall', title: 'S11 · Paywall', file: 'project/caloai/c11-paywall.html' },
  { id: 'c12-diary', title: 'S12 · Diary / Home', file: 'project/caloai/c12-diary.html' },
  { id: 'c13-add-hub', title: 'S13 · Add Meal Hub', file: 'project/caloai/c13-add-hub.html' },
  { id: 'c14-camera', title: 'S14 · AI Meal Camera', file: 'project/caloai/c14-camera.html' },
  { id: 'c15-review', title: 'S15 · AI Analysis / Review', file: 'project/caloai/c15-review.html' },
  { id: 'c16-meal-detail', title: 'S16 · Meal Detail / Edit', file: 'project/caloai/c16-meal-detail.html' },
  { id: 'c17-barcode', title: 'S17 · Barcode Scanner', file: 'project/caloai/c17-barcode.html' },
  { id: 'c18-search', title: 'S18 · Food Search / Manual Entry', file: 'project/caloai/c18-search.html' },
  { id: 'c19-builder', title: 'S19 · Custom Food / Meal Builder', file: 'project/caloai/c19-builder.html' },
  { id: 'c20-plans', title: 'S20 · Plans / Meal Plan', file: 'project/caloai/c20-plans.html' },
  { id: 'c21-recipe', title: 'S21 · Recipe Detail', file: 'project/caloai/c21-recipe.html' },
  { id: 'c22-activity-burn', title: 'S22 · Activity / Burn', file: 'project/caloai/c22-activity-burn.html' },
  { id: 'c23-water', title: 'S23 · Water Tracker', file: 'project/caloai/c23-water.html' },
  { id: 'c24-progress', title: 'S24 · Progress / Analytics', file: 'project/caloai/c24-progress.html' },
  { id: 'c25-metrics', title: 'S25 · Body Metrics', file: 'project/caloai/c25-metrics.html' },
  { id: 'c26-fasting', title: 'S26 · Fasting', file: 'project/caloai/c26-fasting.html' },
  { id: 'c27-healthkit', title: 'S27 · HealthKit Integration', file: 'project/caloai/c27-healthkit.html' },
  { id: 'c28-notifications', title: 'S28 · Notifications', file: 'project/caloai/c28-notifications.html' },
  { id: 'c29-profile', title: 'S29 · Profile / Settings', file: 'project/caloai/c29-profile.html' },
  { id: 'c30-premium', title: 'S30 · Subscription / Premium', file: 'project/caloai/c30-premium.html' },
]
